...
def response_prewarm_texts(player_name: str | None) -> list[str]:
    return [
        ...
        *special_biome_entry_lines("pale_garden", "night"),
        response_text("boss", "ender_dragon", "arena_hint"),
        response_text("boss", "ender_dragon", "summon_commit"),
        response_text("boss", "ender_dragon", "reveal"),
        response_text("boss", "wither", "assembly_hint"),
        response_text("boss", "wither", "reveal"),
        response_text("boss", "warden", "heartbeat_first"),
        response_text("boss", "warden", "heartbeat_close"),
        response_text("boss", "warden", "reveal"),
        response_text("boss", "warden", "defeated"),
        response_text("boss", "warden", "attack_start"),
        *response_lines("boss", "warden", "ranged_trap_lines"),
        response_text("boss", "warden", "golem_army"),
        response_text("boss", "warden", "end_crystal_bombardment"),
        response_text("boss", "warden", "tnt_minecart_setup"),
        response_text("boss", "elder_guardian", "mining_fatigue"),
