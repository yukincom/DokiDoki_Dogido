...
final class DogidoConfig {
    ...
    final int visualConfirmTicks;
    final int visualHoldTicks;
    ...
    private DogidoConfig(
        ...
        this.visualConfirmTicks = visualConfirmTicks;
        this.visualHoldTicks = visualHoldTicks;
